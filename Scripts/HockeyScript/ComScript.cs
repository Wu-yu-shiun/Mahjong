    ...
    private void FixedUpdate()
    {
        if (!PuckScript.WasGoal)
        {
            ...
            if (Puck.position.y < puckBoundary.Down)
            {
                ...
                movementSpeed = MenuManager.MaxMovementSpeed * Random.Range(0.1f, 0.3f);
            ...
            else
            {
                ...
                movementSpeed = Random.Range(MenuManager.MaxMovementSpeed * 0.4f, MenuManager.MaxMovementSpeed);
